...
public class Inventory_Details_Activity extends AppCompatActivity {//Inventory_Details_Activity


    private static final String LOG_TAG = Inventory_Details_Activity.class.getCanonicalName();
    private static final int MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE = 1;

    private Inventory_DBHelper dbHelper;
    EditText nameEdit;
    EditText priceEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {// onCreate
        ...
        setContentView(R.layout.activity_inventory__details);
        ...
        dbHelper = new Inventory_DBHelper(this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_inventory_detals, menu);
        return true;
    }
                ...
                DialogInterface.OnClickListener discardButtonClickListener =
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                NavUtils.navigateUpFromSameTask(Inventory_Details_Activity.this);
                            }
                        };
    ...
    private void addValuesToEditItem(long itemId) {
        ...
        cursor.moveToFirst();
        nameEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_NAME)));
        priceEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_PRICE)));
        quantityEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_QUANTITY)));
        supplierNameEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_SUPPLIER_NAME)));
        supplierPhoneEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_SUPPLIER_PHONE)));
        supplierEmailEdit.setText(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_SUPPLIER_EMAIL)));
        imageView.setImageURI(Uri.parse(cursor.getString(cursor.getColumnIndex(Inventory_Contract.StockEntry.COLUMN_IMAGE))));
    ...
    private int deleteAllRowsFromTable() {
        ...
        return database.delete(Inventory_Contract.StockEntry.TABLE_NAME, null, null);
    }
    ...
    private int deleteOneItemFromTable(long itemId) {
        ...
        int rowsDeleted = database.delete(
                Inventory_Contract.StockEntry.TABLE_NAME, selection, selectionArgs);
        return rowsDeleted;
    }
